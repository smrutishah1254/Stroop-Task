...
expName = 'friday16'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ADMIN\\Desktop\\PSY310 STroop effect\\friday16_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_3 = visual.TextStim(win=win, name='text_3',
        text='Thank you',
        font='Arial',
        units='pix', pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=0.0);
    ...
    thisExp.addData('ins.started', globalClock.getTime(format='float'))
    # keep track of which components have finished
    insComponents = [text_2]
    ...
    thisExp.addData('ins.stopped', globalClock.getTime(format='float'))
    ...
    trials = data.TrialHandler(nReps=100.0, method='random', 
        ...
        trialList=data.importConditions('stroop.csv'),
    ...
    for thisTrial in trials:
        ...
        _key_resp_allKeys = []
        # keep track of which components have finished
        trialComponents = [fixation, text, key_resp]
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['r','b','y','g'], ignoreKeys=["escape"], waitRelease=False)
